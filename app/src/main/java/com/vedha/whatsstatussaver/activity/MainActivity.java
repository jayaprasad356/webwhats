package com.vedha.whatsstatussaver.activity;
...
import com.vedha.whatsstatussaver.Adclick;
import com.vedha.whatsstatussaver.Ads;
import com.vedha.whatsstatussaver.DeletedMessageActivity;
import com.vedha.whatsstatussaver.R;
import com.vedha.whatsstatussaver.activity.stylishfonts.StylishFontsActivity;
import com.vedha.whatsstatussaver.activity.whatsappsticker.StickerPack;
import com.vedha.whatsstatussaver.activity.whatsappsticker.StickerPackDetailsActivity;
import com.vedha.whatsstatussaver.activity.whatsappsticker.StickerPackListActivity;
import com.vedha.whatsstatussaver.activity.whatsappsticker.StickerPackLoader;
import com.vedha.whatsstatussaver.activity.whatsappsticker.StickerPackValidator;
...
public class MainActivity extends AppCompatActivity {
    ImageView imgdirectchat,deletedMessage;
    ImageView imgmore;
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.deletedMessage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MainActivity mainActivity = MainActivity.this;
                mainActivity.startActivity(new Intent(mainActivity, DeletedMessageActivity.class));
            }
        });
        ...
        this.imgprivacypolicy.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                i.setData(Uri.parse("https://www.privacypolicygenerator.info/live.php?token=CFGv0JUTLRSN2B9TSiUb2RQLwh31Nmws"));
                startActivity(i);
            }
        });
