...
import com.vedha.whatsstatussaver.Common;
import com.vedha.whatsstatussaver.R;
import com.vedha.whatsstatussaver.adapter.CustomPagerimageeeeAdapter;
import com.vedha.whatsstatussaver.adapter.StorieSaverImageeeAdapter;
import com.vedha.whatsstatussaver.models.ImagesModel;
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.copy.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                Common.copyFiles(((ImagesModel) displayActivityNewimages.arrayList.get(currentItem)).getImagePath(), getApplicationContext());
            }
        });
    }
