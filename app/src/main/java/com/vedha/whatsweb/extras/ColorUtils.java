package com.vedha.whatsweb.extras;
...
public class ColorUtils {
    ...
    public static ColorStateList generateThumbColorWithTintColor(int i) {
        int i2 = i - -1728053248;
        return new ColorStateList(new int[][]{new int[]{-16842910, CHECKED_ATTR}, new int[]{-16842910}, new int[]{PRESSED_ATTR, -16842912}, new int[]{PRESSED_ATTR, CHECKED_ATTR}, new int[]{CHECKED_ATTR}, new int[]{-16842912}}, new int[]{i - -1442840576, -4539718, i2, i2, i | ViewCompat.MEASURED_STATE_MASK, -1118482});
    }
