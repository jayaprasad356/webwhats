...
import com.vedha.whatsweb.deleted.AlertDialogHelper
import com.google.android.material.switchmaterial.SwitchMaterial
import java.io.File

private const val MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE = 0

class DeletedMessageActivity : AppCompatActivity() {
...
//                ) { dialog, _ -> dialog.cancel() }
    ...
    private fun requestPermission(permission: String, requestCode: Int) {
        if (ContextCompat.checkSelfPermission(this@DeletedMessageActivity,
                permission) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this@DeletedMessageActivity,
